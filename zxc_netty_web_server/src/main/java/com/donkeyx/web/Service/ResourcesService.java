...
public class ResourcesService {
    ...
    private ResourcesService() {
        ...
        try{
            prop.load(ResourcesService.class.getClassLoader().getResourceAsStream(File.separator + Constant.CONFIG_FILE_NAME));
        }catch (Exception e){
        ...
        path = path.substring(firstIndex, lastIndex)+File.separator + Constant.CONFIG_FILE_NAME;
